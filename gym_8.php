...
if (!isset($_SESSION['battle'])) {
    ...
    $_SESSION['battle'] = [
        ...
        "user_team" => $user_team,
        "enemy_team" => [
            "Cobre" => ["hp" => 180, "defeated" => false, "img" => "copper.png", "moves" => [
                "Oxidar" => 55,
                "Eletrizar" => 75,
            ]],
            "Ferro" => ["hp" => 200, "defeated" => false, "img" => "iron.png", "moves" => [
                "Espada de Ferro" => 45,
                "Machado de Ferro" => 50,
                "Picareta de Ferro" => 35,
                "Enchada de Ferro" => 20,
                
            ]],
            "Ouro" => ["hp" => 100, "defeated" => false, "img" => "gold.png", "moves" => [
                "CASH MONEY" => 50,
                "DINHEIRO" => 60,
                "Repelente de Pigling" => 40,
                "Inutilidade" => 10,
                
            ]],
            "Esmeralda" => ["hp" => 200, "defeated" => false, "img" => "emerald.png", "moves" => [
                "Hmmm" => 70,
                "Eh" => 65,
                "Hmm Hmm" => 50,
                "Ehm" => 75,
            ]],
            "Diamante" => ["hp" => 220, "defeated" => false, "img" => "diamond.png", "moves" => [
                "DIAMANTES CARALHO" => 30,
                "Espadada de Diamante" => 60,
                "Knockback II" => 50,
                "Sharpness V" => 85,
...
<html>
<head>
<title>POKEMORCELA - GYM 8</title>
<link href="../css/basic.css" rel="stylesheet">
<link href="../css/gym.css" rel="stylesheet">
</head>
<body>

<h1> GYM 8  - EARTH BADGE </h1>
