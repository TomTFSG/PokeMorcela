...
if (!isset($_SESSION['battle'])) {
    ...
    $_SESSION['battle'] = [
        ...
        "user_team" => $user_team,
        "enemy_team" => [
            "MewDois" => ["hp" => 1000, "defeated" => false, "img" => "mewtwo.png", "moves" => [
                "pewewewewewewe" => 50,
                "Reeeee" => 75,
                "Ataque Mental todo Mamado" => 65,
                "Skidaddle Skidoodle Your Dick Is Now a Noodle" => 80,
            ]],
...
if (isset($_POST['attack'])) {
    ...
    if ($enemyPoke["hp"] <= 0) {
        ...
        if ($battle["enemy_active_index"] < count($battle["enemy_team"])) {
            ...
            header("Location: mewtwo_win.php");
            exit();
            //GO TO WIN SCREEN!!!!!!!!!!!!!!!!
        }
    } else {
