...
if (!isset($_SESSION['battle'])) {
    ...
    $_SESSION['battle'] = [
        ...
        "user_team" => $user_team,
        "enemy_team" => [
            "Callipo" => ["hp" => 190, "defeated" => false, "img" => "calipo.png", "moves" => [
                "Calipo" => 50,
            ]],
            "Bisnaga" => ["hp" => 190, "defeated" => false, "img" => "bisnaga.png", "moves" => [
                "Fazer um Paper" => 70,
                "Conferencia" => 50,
                "Reuniao" => 0,
                "Metes ai AI que fica fixe" => 0,
            ]],
            "Paulada" => ["hp" => 190, "defeated" => false, "img" => "pau.png", "moves" => [
                "Honolulu" => 70,
                "Intiutivo" => 50,
                "Bingu" => 50,
                "Estas Atrasado" => 50,
            ]],
            "Corno" => ["hp" => 190, "defeated" => false, "img" => "corno.png", "moves" => [
                "Epa" => 70,
                "Atraso" => 50,
                "Hmmm" => 50,
                "Chifrudo" => 40,
            ]],
            "Penas Al" => ["hp" => 190, "defeated" => false, "img" => "penas.png", "moves" => [
                "Isso de Design..." => 50,
                "Departamento na Figueira" => 70,
                "Pensar" => 50,
            ]],
            "Cunha" => ["hp" => 190, "defeated" => false, "img" => "cunha.png", "moves" => [
                "Gato" => 50,
                "BetPistao Profits" => 70,
                "Correcoes para o Documento" => 50,
                "Reuniao" => 20,
            ]],
...
if (isset($_POST['attack'])) {
    ...
    if ($enemyPoke["hp"] <= 0) {
        ...
        if ($battle["enemy_active_index"] < count($battle["enemy_team"])) {
            ...
            header("Location: elite4_4_win.php");
            exit();
            //GO TO WIN SCREEN!!!!!!!!!!!!!!!!
        }
    } else {
