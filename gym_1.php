...
if (!isset($_SESSION['battle'])) {
    ...
    $_SESSION['battle'] = [
        ...
        "user_team" => $user_team,
        "enemy_team" => [
            "Calhau" => ["hp" => 50, "defeated" => false, "img" => "calhau.png", "moves" => [
                "Acertar nos Tomates" => 10,
                "Pimba na Testa" => 5,
            ]],
            "Pedragulho" => ["hp" => 55, "defeated" => false, "img" =>"pedragulho.png", "moves" => [
                "Vida de Pedra" => 0,
                "Existir" => 0,
                "Crescer Musgo" => 0,
                "Ganda Pedra" => 10,
...
<html>
<head>
<title>POKEMORCELA - GYM 1</title>
<link href="../css/basic.css" rel="stylesheet">
<link href="../css/gym.css" rel="stylesheet">
</head>
<body>

<h1> GYM 1  - BOULDER BADGE </h1>
