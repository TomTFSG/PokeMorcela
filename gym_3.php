...
if (!isset($_SESSION['battle'])) {
    ...
    $_SESSION['battle'] = [
        ...
        "user_team" => $user_team,
        "enemy_team" => [
            "HTML" => ["hp" => 100, "defeated" => false, "img" => "html.png", "moves" => [
                "«p»" => 15,
                "«a»" => 30,
                "«img»"=> 25,
                "«br»"=> 20,
            ]],
            "CSS" => ["hp" => 90, "defeated" => false, "img" => "css.png", "moves" => [
                "width:100%" => 15,
                "background-color:#2b2b2b" => 30,
                "display:flex"=> 25,
                "font-size:15pts"=> 20,
            ]],
            "Javascript" => ["hp" => 80, "defeated" => false, "img" => "js.png", "moves" => [
                "document.querySelector()" => 15,
