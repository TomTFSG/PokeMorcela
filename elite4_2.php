...
if (!isset($_SESSION['battle'])) {
    ...
    $_SESSION['battle'] = [
        ...
        "user_team" => $user_team,
        "enemy_team" => [
            "Lelonardo" => ["hp" => 170, "defeated" => false, "img" => "leo.png", "moves" => [
                "UMA" => 50,
                "Espadada" => 70,
            ]],
            "Donateto" => ["hp" => 150, "defeated" => false, "img" => "don.png", "moves" => [
                "DUAS" => 50,
                "Paulada"=> 70,
            ]],
            "Micael Angelico" => ["hp" => 150, "defeated" => false, "img" => "mike.png", "moves" => [
                "TRES" => 50,
                "Nunchaku"=> 70,
            ]],
            "Rafalel" => ["hp" => 150, "defeated" => false, "img" => "raph.png", "moves" => [
                "QUATRO" => 50,
                "Facada"=> 70,

            ]],
            "Splitberto" => ["hp" => 150, "defeated" => false, "img" => "splinter.png", "moves" => [
                "NINJAS" => 50,
                "Ratazana Ninja"=> 10,
                "Tecnica Secrreta do Shifu" => 20,
            ]],
...
if (isset($_POST['attack'])) {
    ...
    if ($enemyPoke["hp"] <= 0) {
        ...
        if ($battle["enemy_active_index"] < count($battle["enemy_team"])) {
            ...
            header("Location: elite4_2_win.php");
            exit();
            //GO TO WIN SCREEN!!!!!!!!!!!!!!!!
        }
    } else {
