...
if (!isset($_SESSION['battle'])) {
    ...
    $_SESSION['battle'] = [
        ...
        "user_team" => $user_team,
        "enemy_team" => [
            "Premiere" => ["hp" => 180, "defeated" => false, "img" => "premiere.png", "moves" => [
                "Corta" => 50,
                "Edita Isso" => 70,
            ]],
            "Indesign" => ["hp" => 180, "defeated" => false, "img" => "indesign.png", "moves" => [
                "Font Bonitinha" => 70,
                "Margens" => 50,
            ]],
            "Illustrator" => ["hp" => 180, "defeated" => false, "img" => "illustrator.png", "moves" => [
                "Triangulos" => 70,
                "Quadrados" => 50,
                "Circulos" => 50,
            ]],
            "Arduino" => ["hp" => 180, "defeated" => false, "img" => "arduino.png", "moves" => [
                "beepboop" => 70,
                "Explosão Expontaneea" => 50,
            ]],
            "Processing" => ["hp" => 200, "defeated" => false, "img" => "processing.png", "moves" => [
                "setup()" => 50,
                "draw()" => 70, 
                "Objeto 3D" => 50,
                "Objeto 2D" => 50,
...
if (isset($_POST['attack'])) {
    ...
    if ($enemyPoke["hp"] <= 0) {
        ...
        if ($battle["enemy_active_index"] < count($battle["enemy_team"])) {
            ...
            header("Location: elite4_3_win.php");
            exit();
            //GO TO WIN SCREEN!!!!!!!!!!!!!!!!
        }
    } else {
