...
if (!isset($_SESSION['battle'])) {
    ...
    $_SESSION['battle'] = [
        ...
        "user_team" => $user_team,
        "enemy_team" => [
            "Granada" => ["hp" => 10, "defeated" => false, "img" => "grenade.png", "moves" => [
                "BOOOOOM" => 400,
            ]],
            "P250" => ["hp" => 100, "defeated" => false, "img" => "p250.png", "moves" => [
                "Bang" => 45,
                "PAN" => 50,
                "Pew Pew" => 55,
                "PAPAPA" => 60,
            ...
            "RPG" => ["hp" => 200, "defeated" => false, "img" => "rpg.png", "moves" => [
                "KABOOM" => 90,
                "Missil Fodilhao" => 65,
                "Miss" => 0,
                "Errou" => 0,
