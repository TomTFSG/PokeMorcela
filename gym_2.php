...
if (!isset($_SESSION['battle'])) {
    ...
    $_SESSION['battle'] = [
        ...
        "user_team" => $user_team,
        "enemy_team" => [
            "Sumol Laranja" => ["hp" => 70, "defeated" => false, "img" => "sumol.png", "moves" => [
                "Sabor Refrescante" => 10,
                "Owned by the Coca-Cola Company" => 25,
            ]],
            "Prota" => ["hp" => 55, "defeated" => false, "img" =>"prota.png", "moves" => [
                "Incha" => 10,
                "30 CRL" => 30,
            ]]
        ],
