...
if (!isset($_SESSION['battle'])) {
    ...
    $_SESSION['battle'] = [
        ...
        "user_team" => $user_team,
        "enemy_team" => [
            "Braços" => ["hp" => 150, "defeated" => false, "img" => "arms.png", "moves" => [
                "Soco" => 50,
                "Manguito" => 70,
                "Flex" => 50,
            ]],
            "Pernas" => ["hp" => 150, "defeated" => false, "img" => "legs.png", "moves" => [
                "Pontape nos Tomates" => 70,
                "Salto" => 50,
                "Flex" => 50,
            ]],
            "Peito" => ["hp" => 150, "defeated" => false, "img" => "chest.png", "moves" => [
                "Major Pectoralis" => 70,
                "Minor Pectoralis" => 50,
                "Flex" => 50,
            ]],
...
if (isset($_POST['attack'])) {
    ...
    if ($enemyPoke["hp"] <= 0) {
        ...
        if ($battle["enemy_active_index"] < count($battle["enemy_team"])) {
            ...
            header("Location: elite4_1_win.php");
            exit();
            //GO TO WIN SCREEN!!!!!!!!!!!!!!!!
        }
    } else {
