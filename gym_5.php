...
if (!isset($_SESSION['battle'])) {
    ...
    $_SESSION['battle'] = [
        ...
        "user_team" => $user_team,
        "enemy_team" => [
            "Whiskey" => ["hp" => 120, "defeated" => false, "img" => "whiskey.png", "moves" => [
                "Jack Daniels no 7" => 35,
                "Jameson" => 45,
                "Red Label"=> 50,
                " J&B"=> 35,
            ]],
            "Vodka" => ["hp" => 130, "defeated" => false, "img" => "vodka.png", "moves" => [
                "Absolute" => 35,
                "Smirnoff" => 45,
                "Moskovskaya"=> 50,
                "Miss"=> 35,
            ]],
            "Tequila" => ["hp" => 110, "defeated" => false, "img" => "tequila.png", "moves" => [
                "Sierra" => 35,
                "Don Julio" => 45,
                "San Jose"=> 50,
                "Jose Cuervo"=> 35,
            ]],
            "Gin" => ["hp" => 110, "defeated" => false, "img" => "gin.png", "moves" => [
                "Tanqueray" => 35,
                "Gordon's" => 45,
                "Nordes"=> 50,
                "Beefeater"=> 35,
